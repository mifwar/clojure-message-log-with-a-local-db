...
message_log_3.views.display_messages = (function message_log_3$views$display_messages(p__31974){
var map__31975 = p__31974;
var map__31975__$1 = cljs.core.__destructure_map(map__31975);
var unix_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31975__$1,new cljs.core.Keyword(null,"unix-time","unix-time",-781363207));
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31975__$1,new cljs.core.Keyword(null,"message","message",-406056002));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.input","input.input",-850828147),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(value),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__31979_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("message-log-3.events","update-db","message-log-3.events/update-db",704340530),id,p1__31979_SHARP_.target.value], null));
